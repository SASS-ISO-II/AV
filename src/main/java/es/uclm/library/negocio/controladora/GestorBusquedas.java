...
public class GestorBusquedas {
    ...
    public String buscar(@RequestParam(required = false) String localizacion, @RequestParam(required = false) Double precioMax,
            @RequestParam(required = false) Integer capacidad, @RequestParam(required = false) String tipo, Model model) {
